...
import pandas as pd
from utils.supervisedContrastiveLoss import TwoCropTransform
...
class ContrastiveCIFAR10DataBuilder:
    ...
    def get_default_transforms(self):
        contrastiveLossTransforms = transforms.Compose([
        ...
        transform = TwoCropTransform(contrastiveLossTransforms)
    ...
    def get_datasets(self, client_id, transform_train=None, transform_test=None, pool=False):
        ...
        print("Training")
        train_ds = ContrastiveCIFAR10Dataset(train_images, train_labels, client_id, 0, transform_train)
        print("Validation")
        val_ds = ContrastiveCIFAR10Dataset(val_images, val_labels, client_id, 1,  transform_test)
        print("Testing")
        test_ds = ContrastiveCIFAR10Dataset(test_images, test_labels, client_id, 2, transform_test)

        return train_ds, val_ds, test_ds

if __name__ == '__main__':
    cifar_builder = ContrastiveCIFAR10DataBuilder()
    client_id = 0
